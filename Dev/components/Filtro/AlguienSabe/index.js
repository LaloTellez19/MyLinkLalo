                ...
                <View style={styles.encabezado}>
                  <View style={styles.encabezadoMyBusiness}>
                    <IconsArray
                      name={
                        alguienSabeData
                          ? categorias[alguienSabeData.category].name
                          : 'unknown'
                      }
                    />
                    <View style={{marginLeft: 15}}>
                      <Text style={styles.encabezadoTipo}>
                        {alguienSabeData.type}
                      </Text>
                      <Text style={styles.encabezadoEspecialidad}>
                        {alguienSabeData.specialty}
                      </Text>
                    </View>
                  </View>
...
const IconsArray = ({name, color}) => {
  return (
    <View style={styles.iconsArray}>
      <Icon name={name} factor={0.9} forceColor color={'white'} background={color ? color : Colors.gray} />
      <Icon name={name} factor={0.9} forceColor color={'white'} background={color ? color : Colors.gray} />
      <View style={styles.iconMedio}>
        <Icon name={name} factor={0.9} forceColor color={'white'} background={color ? color : Colors.gray} />
      </View>
    </View>
  );
