...
class LinkBusinessBlock extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      menu: [
        ...
        {
          icon: this.props.data.tipo === 0 ? 'videocall' : 'location',
          text: 'Mapa',
        },
        {
          icon: this.props.data.tipo === 0 ? 'sms' : 'message_send',
          text: 'Web',
        },
      ],
      showAll: false,
...
export default LinkBusinessBlock;
