...
function Location(props) {
  const {index: mainIndex, data, handleSaveChanges,user} = props;
  const labels = [
    'calle y número',
    'colonia',
    'estado',
  ...
  const [selectedCountry, setSelectedCountry] = React.useState(user.pais);
  ...
  return (
    ...
    <TouchableWithoutFeedback
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={{width: '20%', backgroundColor: 'white', alignContent: 'center', justifyContent: 'center', alignItems: 'center', borderBottomWidth: 1,borderBottomColor: Colors.silver}}>
                <Icon
                    name='location'
                    size={40}
                    factor={1}
            ...
            <View style={{width: '80%', backgroundColor: 'white', alignContent: 'center', justifyContent: 'center', borderBottomWidth: 1,borderBottomColor: Colors.silver}}>
